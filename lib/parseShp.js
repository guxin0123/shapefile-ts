class ParseShp {
    constructor(buffer, trans) {
        ...
        this.parsePolygon = (data) => {
            return this.polyFuncs(this.parsePolyline(data));
        };
        this.parseZPolygon = (data) => {
...
//# sourceMappingURL=parseShp.js.map